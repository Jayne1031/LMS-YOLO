...
__all__ = ['MCALayer', 'MCAGate',"C2f_MCAGate"]
...
class C2f_MCAGate(nn.Module):
    ...
    def forward(self, x):
        ...
        # y.append(self.mca(y[-1])) # 官方改法
        return self.mca(self.cv2(torch.cat(y, 1)))
