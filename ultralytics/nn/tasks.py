...
from ultralytics.utils.plotting import feature_visualization,draw_feature_map1
    ...
    def _predict_once(self, x, profile=False, visualize=False, embed=None):
        ...
        for m in self.model:
            ...
            if visualize:
                ...
                draw_feature_map1(x, org_x, m.type, m.i, save_dir=visualize)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    #     n = n_ = max(round(n * depth), 1) if n > 1 else n  # depth gain
        ...
        if m in {
            ...
            c1, c2 = ch[f], args[0]
            if c2 != nc and m not in [UniversalInverted,ConvBNReLU]:  # if c2 not equal to number of classes (i.e. for Classify() output)
            ...
            if m in {
                ...
                n = 1
            if m in [C3k2, C3k2_LCA3, C3k2_LCA3_2, C3k2_UIB_Final, C3k2_UIB_Replace]:  # for M/L/X sizes
                legacy = False
                if scale in "mlx":
                    args[3] = True
        elif m is AIFI:
